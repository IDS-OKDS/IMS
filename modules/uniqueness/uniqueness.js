...
(function($) {
  ...
  Drupal.behaviors.uniqueness = {
    attach: function (context) {
      ...
      // Search off title.
      /* Joe McP -- just added #edit-title-field-und-0-value to selector (for translation title) */
      $('#edit-title, #edit-title-field-und-0-value', context).once('uniqueness', function() {
        $(this).keyup(function() {
          input = this.value;
